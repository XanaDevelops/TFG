...
, function(e, t) {
    e.exports = function(e, t) {
        ...
        let r = e.key
          , s = e.keyCode;
        if ("vr" === t)
            s = parseInt(document.querySelector(`#${e.target.id}`).getAttribute("key-code")),
            r = document.querySelector(`#${e.target.id}`).getAttribute("value");
        else if (d.has(e.keyCode))
            return;
        switch (s) {
        case 9:
